...
> Create a game where a cat catches fish while avoiding sharks.
...
Claude Code is an AI coding assistant.
...
Your job is NOT to build the game.

Your job is to interview me and help me design the best possible game.

Ask me ONE question at a time.

Keep your questions simple because I am a beginner.
...
The final prompt should be ready to give to an AI coding agent.

The final prompt must clearly describe every feature needed to build the game.

Do not generate code.

Only generate the final game specification.
```
